...
const About = () => {
  ...
  return (
    <WrapperSC style={{  paddingBottom: "113px"}} className="container-two">
      ...
      <ParagraphSC>
        Компания СпецСтрой зарекомендовала себя как солидный и надежный партнер для многих компаний работающих в области закупок, проектирования и производства деталей. У нас вы можете найти запчасти для любой спецтехники. Широкий ассортимент и приятные цены ждут вас! Мы гарантируем, что представленные товары прослужат долго. Покупайте у нас, ведь все наши запчасти оригинальные.
      </ParagraphSC>
      <PdfContainer>
        <PdfTextSC>
